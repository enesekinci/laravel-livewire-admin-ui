...
5. Forms: wrap sections in `x-admin.card`; lists in `x-admin.table`.
6. Always keep Tailwind `@source` for this package views.
7. Branding/layout shell stays in the **app**; this package is components only.
8. If a needed primitive is missing, extend **this package** (not the app), bump tag, require update.
